package com.huawei._2_sys_layout_designer.provider;
...
import com.huawei._2_sys_layout_designer.provider.subprovider.SubProvider;

public class MainProvider {
	// #region split

	public static String split(GraphvizBuGraphVo oGraphvizBuGraphVo) {
		return SubProvider.split(oGraphvizBuGraphVo);
	}
	...
	public static String save(GraphvizGraphVo oGraphvizGraphVo) {
		return SubProvider.save(oGraphvizGraphVo);
	}
	...
	public static List<GraphvizNodeVo> layout(GraphvizBuGraphVo oGraphvizBuGraphVo) {
		return SubProvider.layout(oGraphvizBuGraphVo);
	}
